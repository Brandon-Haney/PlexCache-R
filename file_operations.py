...
class FilePathModifier:
    ...
    .. deprecated::
        This class is deprecated. Use MultiPathModifier instead.
        FilePathModifier uses legacy path arrays (plex_library_folders,
        nas_library_folders) which are no longer generated by the setup wizard.
        All path conversion should now use path_mappings via MultiPathModifier.
    """
